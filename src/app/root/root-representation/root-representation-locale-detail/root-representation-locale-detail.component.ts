...
@Component({
  selector: 'app-root-representation-locale-detail',
  templateUrl: './root-representation-locale-detail.component.html',
  styleUrls: ['./root-representation-locale-detail.component.css']
})
export class RootRepresentationLocaleDetailComponent implements OnInit {
  currentLocale = null;
  lists: any = {};
